...
See also the utility's help option. `pepenet-blockchain-stats --help`
...
- `pepenet-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `pepenet-blockchain-stats | save-to-database.sh`

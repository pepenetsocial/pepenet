...
RUN	git clone https://github.com/pepenet-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/pepenet-project/pepenet
...
if [ ! -d sigs ]; then
	git clone https://github.com/pepenet-project/gitian.sigs.git sigs
	cd sigs

...
- [ ] Notify wallets
  ...
  - [ ] XMRWallet
- [ ] Notify exchanges
  - [ ] https://web.getpepenet.org/community/merchants/#exchanges
- [ ] Notify 3rd party payment processors
  - [ ] https://web.getpepenet.org/community/merchants/#payment-gateways
- [ ] Notify mining pools
  - [ ] https://miningpoolstats.stream/pepenet
- [ ] Release tagged
  ...
  - [ ] Update src/blocks/checkpoints.dat with ./pepenet-blockchain-export --output-file checkpoints.dat --block-stop <recent block height> --blocksdat
...
- [ ] CLI released
  - [ ] https://web.getpepenet.org/downloads/ updated
